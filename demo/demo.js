...
function initPlayers() {
    ...
    window.dp1 = new XPlayer({
        ...
        video: {
            ...
            thumbnails: {
                url: 'https://i.loli.net/2019/06/06/5cf8c5d9cec8510758.jpg',
                count: 100,
            }
        },
        highlight: [
    ...
    window.dp2 = new XPlayer({
        ...
        contextmenu: [
            {
                text: 'GITHUB',
                link: 'https://github.com/AnvinMao/x-player'
            }
        ]
    });
...
function switchDPlayer() {
    if (video === 1) {
        ...
        dp2.switchVideo({
            ...
            poster: 'https://i.loli.net/2019/06/06/5cf8c5d9c57b510947.png',
            thumbnails: {
                url: 'http://static.smartisanos.cn/pr/img/video/video_03_cc87ce5bdb.jpg',
                count: 100,
            },
            type: 'auto'
        });
